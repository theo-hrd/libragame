when registering, even if its saying error, it keeps the registration in cache and when it finally works, it sends all of the inputs when it wasnt working before // seems like its fixed
